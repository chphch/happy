...
export function startDaemonControlServer({
  ...
  return new Promise((resolve) => {
    ...
    typed.post('/spawn-session', {
      ...
      const { directory, sessionId, agent, environmentVariables, resumeClaudeSessionId, parentSessionId, forkedFromMessageId } = request.body;
      ...
      const result = await spawnSession({ directory, sessionId, agent, environmentVariables, resumeClaudeSessionId, parentSessionId, forkedFromMessageId });
