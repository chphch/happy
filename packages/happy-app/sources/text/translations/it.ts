...
export const it: TranslationStructure = {
    ...
    projectOrder: {
        title: 'Riordina progetti',
        hint: 'Trascina un progetto dalla maniglia per spostarlo. L\'ordine si sincronizza tra i tuoi dispositivi.',
        done: 'Fine',
        moveUp: 'Sposta su',
        moveDown: 'Sposta giù',
        empty: 'Nessun progetto da riordinare',
    },
