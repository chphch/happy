...
import { installImeDebug } from '@/utils/imeDebug';

// Module scope so the ?imeDebug overlay query is still in location.search —
// by the time a composer mounts, client-side routing has already stripped it.
installImeDebug();
