...
export function SessionsList() {
    ...
    // time, so `data` doesn't change reference when a project is (un)starred.
    // Subscribe here and thread it through FlatList's extraData so the native
    // list actually repaints the reordered rows (web re-renders eagerly; native
    // FlatList memoizes cells and would otherwise show stale order until a nav).
