...
/**
 * The starred project keys the home list orders by, empty while the
 * experimental toggle is off — a star left over from when it was on must not
...
export function useSessionListStarredProjects(): ReadonlySet<string> {
    ...
    return starProjectsEnabled ? starredProjects : EMPTY_STARRED;
}
