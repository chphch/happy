        ...
        const flushRun = () => {
            ...
            groups.push({
                ...
                item: {
                    ...
                    // Collected groups hold work OLDER than the turn's final text, so the
                    // turn is complete — a hidden tool left in a stale 'running' state must
                    // not resurrect the group's spinner (upstream #1463).
                    hasRunning: false,
