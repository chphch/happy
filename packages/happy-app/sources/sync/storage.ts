...
import { loadSettings, loadLocalSettings, saveLocalSettings, saveSettings, loadPurchases, savePurchases, loadProfile, saveProfile, loadSessionDrafts, saveSessionDrafts, loadSessionPermissionModes, saveSessionPermissionModes, loadStarredSessions, saveStarredSessions } from "./persistence";
...
export const storage = create<StorageState>()((set, get) => {
    ...
    return {
        ...
        applySessions: (sessions: (Omit<Session, 'presence'> & { presence?: "online" | number })[]) => set((state) => {
            // Load drafts, permission modes, and starred state if sessions are empty (initial load)
