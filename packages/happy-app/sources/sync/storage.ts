...
function buildSessionListViewData(
    ...
    const toRow = (session: Session) => buildSessionRowData(session, currentViewingSessionId, machines);
    ...
    return {
        ...
        updateSessionDraft: (sessionId: string, draft: string | null) => set((state) => {
            ...
            return {
                ...state,
                sessions: updatedSessions,
                sessionListViewData: buildSessionListViewData(updatedSessions, state.currentViewingSessionId, state.machines)
            };
        }),
        ...
        deleteMachine: (machineId: string) => set((state) => {
            ...
            return {
                ...state,
                machines: remaining,
                sessionListViewData: buildSessionListViewData(state.sessions, state.currentViewingSessionId, remaining)
            };
        }),
        // Artifact methods
        ...
        deleteSession: (sessionId: string) => set((state) => {
            ...
            const sessionListViewData = buildSessionListViewData(remainingSessions, state.currentViewingSessionId, state.machines);
        ...
        applySessionLastMessage: (sessionId: string, seq: number, createdAt?: number) => set((state) => {
            ...
            return {
                ...state,
                sessions,
                sessionListViewData: buildSessionListViewData(sessions, state.currentViewingSessionId, state.machines),
            };
        }),
