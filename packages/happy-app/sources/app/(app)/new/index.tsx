...
function NewSessionScreen() {
    ...
    }, [allMachines, canPickWorktree, clearImages, currentEffort?.key, currentModelKey, currentPermission?.key, effectiveAgentDefaults.effortLevel, effectiveAgentDefaults.modelMode, effectiveAgentDefaults.permissionMode, expImageUpload, navigateToSession, router, selectedAgent, selectedMachineId, selectedPath, worktreeKey]);
